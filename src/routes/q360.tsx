  ...
  head: () => ({
    meta: [
      { title: "Q360 — قياس الأثر القرآني" },
      {
        name: "description",
        content:
          "نظام تقييم شامل يقيس أثر التدريب والتطبيق على سلوك المتدرب قبل التدريب وبعده وبعد شهر من التطبيق.",
      },
...
const raters = [
  ...
  "الزملاء",
  "المدير/المشرف",
  "الأشخاص الذين يعمل معهم أو تحت إشرافه",
];
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 md:py-16">
      <PageHero
        eyebrow="تعلّم. طبّق. قيّم. تغيّر."
        title="Q360 — قياس الأثر القرآني"
        description={`نظام تقييم شامل يقيس أثر التدريب والتطبيق على سلوك المتدرب من خلال التقييم الذاتي وتقييم الأشخاص المحيطين به، قبل التدريب وبعده وبعد مرور شهر على التطبيق. السعر ${data["price_q360"]} ريال.`}
        actions={
          <Button asChild variant="secondary">
            <Link to="/store">
              شراء خدمة Q360 <ArrowLeft />
            </Link>
          </Button>
        }
      >
        <div className="grid gap-3 sm:grid-cols-3">
          ...
          <HeroStat value="5" label="أنواع من المقيمين" />
          <HeroStat value="3" label="نقاط قياس زمنية" />
        </div>
      </PageHero>
      ...
      <section className="mt-16">
        <SectionTitle
          title="قياسٌ يرى التغيير"
          subtitle="تقييم متعدد الزوايا يساعد المتدرب والجهة على فهم ما تغيّر وما يحتاج إلى دعم."
        />
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <section className="rounded-2xl border border-border bg-card p-6">
            ...
            <p className="mt-3 leading-8 text-muted-foreground">
              «يبادر إلى إنجاز الأعمال النافعة دون انتظار أن يُطلب منه ذلك.»
            </p>
          </section>
        </div>
      </section>
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-3">
        {[
          ["قبل التدريب", "القياس القبلي"],
          ["بعد التدريب", "القياس البعدي"],
          ["بعد شهر", "قياس الاستدامة"],
        ].map(([t, d]) => (
